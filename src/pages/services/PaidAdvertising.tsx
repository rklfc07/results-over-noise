...
import { ArrowRight, Check, Target, BarChart3, RefreshCw, Zap } from 'lucide-react';
...
const features = [
  {
    icon: Target,
    title: 'Google Ads',
    description: 'Search, Display, and Shopping campaigns that capture high-intent customers at the moment they\'re ready to buy.',
  },
  {
    icon: Zap,
    title: 'Meta Ads',
    description: 'Facebook and Instagram campaigns that build awareness and drive conversions with precise audience targeting.',
  },
  {
    icon: BarChart3,
    title: 'Programmatic',
    description: 'Automated ad buying across premium placements to reach your audience at scale.',
  },
  {
    icon: RefreshCw,
    title: 'Retargeting',
    description: 'Bring back visitors who didn\'t convert with strategic remarketing campaigns.',
  },
];
    ...
    <div ref={pageRef} className="bg-ron-dark pt-24 pb-16 lg:pt-32 lg:pb-24">
      <div className="w-full px-5 lg:px-[5vw]">
        ...
        <div className="flex items-center gap-2 mb-6 text-sm">
          ...
          <span className="text-ron-yellow">Paid Advertising</span>
        </div>
        ...
        <div className="page-header mb-10 lg:mb-14">
          <h1 className="font-display font-bold text-3xl sm:text-4xl lg:text-[clamp(36px,4vw,56px)] leading-[1.05] tracking-[-0.03em] text-white mb-4">
            Paid <span className="text-ron-yellow">Advertising</span>
          </h1>
          <p className="text-ron-text-secondary text-base lg:text-lg max-w-2xl mb-8">
            Turn ad spend into revenue with data-driven campaigns. We manage Google Ads and Meta
            campaigns that deliver consistent, profitable results.
          </p>
        ...
        <div className="process-card p-5 lg:p-6 bg-ron-yellow/5 border-ron-yellow/20">
          <h3 className="font-display font-semibold text-lg text-white mb-3">Ready to scale?</h3>
          <p className="text-ron-text-secondary text-sm mb-5">
            Most clients see measurable results within the first 30 days of campaign launch.
          </p>
          <Link to="/contact" className="btn-primary inline-flex items-center gap-2">
